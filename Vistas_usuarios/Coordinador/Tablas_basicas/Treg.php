    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="Tcom.php"><i class="fa fa-circle-o"></i>Tabla Comuna</a></li>
            <li><a href="Treg.php"><i class="fa fa-circle-o"></i>Tabla Región</a></li>
            <li><a href="Tgen.php"><i class="fa fa-circle-o"></i>Tabla Género</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="active">Tabla Región</a></li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
              <form action="MTcom.php" method="POST" method="POST" role="form">
                ...
                <div class="form-group">
                  <label>Región</label>
                 <input name=region type="text" class="form-control" placeholder="Los Ríos">
                </div>
                <div class="col-xs-4"> 
          ...
          <div class="box box-danger">
            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <form action="MTcom.php" method="POST" method="POST" role="form">
                  <div class="form-group">
                    <label>Seleccione la región a modificar:</label>
