  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="active">Tabla Tipo_falta</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="MTtfa.php" method="POST" method="POST" role="form">
                <!-- select -->
                <div class="form-group">
                  <label>Tipo_falta</label>
                 <input name=tfa type="text" class="form-control" placeholder="">
                </div>
  
                <div class="form-group">
                  <label>Valor asignado</label>
                 <input name=valor type="text" class="form-control" placeholder="">
                </div>
                <div class="col-xs-4"> 
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <form action="MTtfa.php" method="POST" method="POST" role="form">
                <div class="form-group">
                  <label>Tipo_falta</label>
                  <select name="tfa" required class="form-control">
                    <option></option>
                    <?php
                      ...
                      if($filas > 0)
                      {
                        ...
                        {
                              echo "<option value=".$result["TFA_ID"].">".$result["TFA_NOMBRE"]." - ".$result["TFA_VALOR"]."</option>";
                          }
                      }
                    ?>
                  </select>
            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <form action="MTtfa.php" method="POST" method="POST" role="form">
                  <div class="form-group">
                    <label>Seleccione el tipo de falta a modificar:</label>
                    <select name=tfaid required class="form-control">
                      <option></option>
                      <?php
                        $con = new mysqli($servidor, $usuario, $password, $bd);
                        $con->set_charset("utf8");
