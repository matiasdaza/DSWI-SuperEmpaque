  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="active">Tabla tipo de turno</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="MTttu.php" method="POST" method="POST" role="form">
                <!-- select -->
                <div class="form-group">
                  <label>Tipo de turno</label>
                 <input name=ttu type="text" class="form-control" placeholder="">
                </div>
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <form action="MTttu.php" method="POST" method="POST" role="form">
                <div class="form-group">
                  <label>Tipo de turno</label>
                  <select name="ttu" required class="form-control">
                    <option></option>
                    <?php
                      ...
                      if($filas > 0)
                      {
                        ...
                        {
                              echo "<option value=".$result["TTU_ID"].">".$result["TTU_NOMBRE"]."</option>";
                          }
                      }
                    ?>
                  </select>
            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <form action="MTttu.php" method="POST" method="POST" role="form">
                  <div class="form-group">
                    <label>Seleccione el Tipo de turno a modificar:</label>
                    <select name= ttuid required class="form-control">
                      <option></option>
                      <?php
                        $con = new mysqli($servidor, $usuario, $password, $bd);
                        $con->set_charset("utf8");
