...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Tabla Casa de estudios
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="#">Mantención de tablas</a></li>
        <li><a href="active">Tabla Casa de estudios</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="MTcest.php" method="POST" method="POST" role="form">
                <!-- select -->
                <div class="form-group">
                  <label>Casa de estudios</label>
                 <input name=cest type="text" class="form-control" placeholder="">
                </div>
          ...
          <div class="box box-danger">
            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <form action="MTcest.php" method="POST" method="POST" role="form">
                  <div class="form-group">
                    <label>Seleccione el Casa de estudios a modificar:</label>
                    <select name="cestid" required class="form-control">
                      <option></option>
                      <?php
                        $con = new mysqli($servidor, $usuario, $password, $bd);
                        $con->set_charset("utf8");
