...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Tabla Tipo de justificación
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="#">Mantención de tablas</a></li>
        <li><a href="active">Tabla Tipo de justificación</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="MTjus.php" method="POST" method="POST" role="form">
                <!-- select -->
                <div class="form-group">
                  <label>Tipo de justificación</label>
                 <input name=tjus type="text" class="form-control" placeholder="">
                </div>
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <form action="MTjus.php" method="POST" method="POST" role="form">
                <div class="form-group">
                  <label>Tipo de justificación</label>
                  <select name="tjus" required class="form-control">
                    <option></option>
                    <?php
                      ...
                      if($filas > 0)
                      {
                        ...
                        {
                              echo "<option value=".$result["TJUS_ID"].">".$result["TJUS_TIPO"]."</option>";
                          }
                      }
                    ?>
                  </select>
            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <form action="MTjus.php" method="POST" method="POST" role="form">
                  <div class="form-group">
                    <label>Seleccione el Tipo de justificación a modificar:</label>
                    <select name=tjusid required class="form-control">
                      <option></option>
                      <?php
                        $con = new mysqli($servidor, $usuario, $password, $bd);
                        $con->set_charset("utf8");
