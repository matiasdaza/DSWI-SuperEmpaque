  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="active">Tabla Situación</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="MTsit.php" method="POST" method="POST" role="form">
                <!-- select -->
                <div class="form-group">
                  <label>Situación</label>
                 <input name=sit type="text" class="form-control" placeholder="">
                </div>
          ...
          <div class="box box-danger">
            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <form action="MTsit.php" method="POST" method="POST" role="form">
                  <div class="form-group">
                    <label>Seleccione la situación a modificar:</label>
                    <select name=sitid required class="form-control">
                      <option></option>
                      <?php
                        $con = new mysqli($servidor, $usuario, $password, $bd);
                        $con->set_charset("utf8");
